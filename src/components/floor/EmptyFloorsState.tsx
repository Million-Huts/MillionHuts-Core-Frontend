...
export default function EmptyFloorsState({ onAdd }: { onAdd: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center rounded-sm border-2 border-dashed border-primary/20 bg-muted/10 py-24 px-8 text-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <Button
                onClick={onAdd}
                className="h-14 rounded-sm px-10 font-black shadow-lg shadow-primary/20 gap-2 text-base"
            >
