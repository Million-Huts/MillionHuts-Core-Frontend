...
export default function EmptyRulesState({ onCreate }: { onCreate: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center md:py-16 py-8 md:px-6 px-1 border-2 border-dashed md:rounded-[2rem] rounded-lg bg-muted/20 text-center transition-all hover:bg-muted/30">
