...
export default function EmptyRulesState({ onCreate }: { onCreate: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center py-24 px-6 border-2 border-dashed border-muted-foreground/20 rounded-sm bg-muted/20 text-center transition-all hover:bg-muted/30 hover:border-primary/20">
            {/* Visual Icon */}
            ...
            {/* Action */}
            <Button onClick={onCreate} className="h-12 rounded-sm px-8 gap-2 font-bold shadow-lg shadow-primary/20">
