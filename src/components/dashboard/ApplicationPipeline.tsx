...
export default function ApplicationPipeline({ data }: ApplicationPipelineProps) {
    return (
        <Card className="border-border bg-card rounded-sm shadow-sm transition-all hover:shadow-md">
            ...
            <CardContent className="space-y-5">
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="relative overflow-hidden bg-muted/30 border border-border/50 p-4 rounded-sm group transition-colors hover:bg-muted/50">
                ...
                {data.flags.hasStalePending ? (
                    <motion.div
                        ...
                        className="flex items-center gap-3 px-4 py-3 rounded-sm bg-destructive/10 text-destructive border border-destructive/10"
                    >
