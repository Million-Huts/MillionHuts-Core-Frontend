...
function StatCard({ label, val, icon: Icon, variant, index }: StatCardProps) {
    ...
    return (
        <motion.div
            ...
            className="group relative bg-card p-5 rounded-sm shadow-sm border border-border flex items-center gap-5 transition-all hover:shadow-md hover:border-primary/20"
        >
            {/* Icon Container */}
            <div className={cn(
